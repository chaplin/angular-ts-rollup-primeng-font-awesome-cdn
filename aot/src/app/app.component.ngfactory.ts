...
import * as import11 from '../../../src/app/header/header.component';
...
export function viewFactory_AppComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AppComponent> {
  if ((renderType_AppComponent === (null as any))) { (renderType_AppComponent = viewUtils.createRenderComponentType('c:/Users/sshrestha/Source/Repos/Angular Projects In ShresthaSamr@GitHub/angular-ts-rollup-ngprime-font-awesome-cdn/src/app/app.component.html',0,import8.ViewEncapsulation.Emulated,styles_AppComponent,{})); }
