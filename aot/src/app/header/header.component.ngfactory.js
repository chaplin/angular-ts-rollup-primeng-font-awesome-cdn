...
export function viewFactory_HeaderComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_HeaderComponent === null)) {
        (renderType_HeaderComponent = viewUtils.createRenderComponentType('c:/Users/sshrestha/Source/Repos/Angular Projects In ShresthaSamr@GitHub/angular-ts-rollup-ngprime-font-awesome-cdn/src/app/header/header.component.html', 0, import8.ViewEncapsulation.None, styles_HeaderComponent, {}));
    }
