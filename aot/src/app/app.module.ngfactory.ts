...
import * as import31 from './header/header.component.ngfactory';
...
import * as import40 from '../../../src/app/header/header.component';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  constructor(parent:import30.Injector) {
    super(parent,[
      import31.HeaderComponentNgFactory,
      import31.HeaderComponentNgFactory,
  ...
  get _APP_ID_17():any {
    if ((this.__APP_ID_17 == (null as any))) { (this.__APP_ID_17 = import33._appIdRandomProviderFactory()); }
  ...
  get _EventManager_21():import15.EventManager {
    if ((this.__EventManager_21 == (null as any))) { (this.__EventManager_21 = new import15.EventManager(this._EVENT_MANAGER_PLUGINS_20,this.parent.get(import36.NgZone))); }
  ...
  get _RootRenderer_25():any {
    if ((this.__RootRenderer_25 == (null as any))) { (this.__RootRenderer_25 = import37._createConditionalRootRenderer(this._DomRootRenderer_24,this.parent.get(import37.NgProbeToken,(null as any)))); }
  ...
  get _LocationStrategy_41():any {
    if ((this.__LocationStrategy_41 == (null as any))) { (this.__LocationStrategy_41 = import8.provideLocationStrategy(this.parent.get(import38.PlatformLocation),this.parent.get(import39.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_40)); }
  ...
  get _ROUTES_46():any[] {
      if ((this.__ROUTES_46 == (null as any))) { (this.__ROUTES_46 = [[
        {
          path: 'header',
          component: import40.HeaderComponent
        }
        ,
        {
          path: '',
  ...
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_6 = import8.provideForRootGuard(this.parent.get(import41.Router,(null as any)));
    ...
    this._Testability_13 = new import11.Testability(this.parent.get(import36.NgZone));
    this._ApplicationRef__14 = new import12.ApplicationRef_(this.parent.get(import36.NgZone),this.parent.get(import42.Console),this,this._ErrorHandler_11,this,this._ApplicationInitStatus_12,this.parent.get(import11.TestabilityRegistry,(null as any)),this._Testability_13);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import33.APP_ID)) { return this._APP_ID_17; }
    ...
    if ((token === import53.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_45; }
    if ((token === import54.ROUTES)) { return this._ROUTES_46; }
    if ((token === import41.Router)) { return this._Router_47; }
    if ((token === import55.ActivatedRoute)) { return this._ActivatedRoute_48; }
