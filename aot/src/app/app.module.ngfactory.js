...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_APP_ID_17", {
        get: function () {
            if ((this.__APP_ID_17 == null)) {
                (this.__APP_ID_17 = import33._appIdRandomProviderFactory());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventManager_21", {
        get: function () {
            if ((this.__EventManager_21 == null)) {
                (this.__EventManager_21 = new import15.EventManager(this._EVENT_MANAGER_PLUGINS_20, this.parent.get(import36.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RootRenderer_25", {
        get: function () {
            if ((this.__RootRenderer_25 == null)) {
                (this.__RootRenderer_25 = import37._createConditionalRootRenderer(this._DomRootRenderer_24, this.parent.get(import37.NgProbeToken, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_XSRFStrategy_36", {
        get: function () {
            if ((this.__XSRFStrategy_36 == null)) {
                (this.__XSRFStrategy_36 = import7._createDefaultCookieXSRFStrategy());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Http_39", {
        get: function () {
            if ((this.__Http_39 == null)) {
                (this.__Http_39 = import7.httpFactory(this._XHRBackend_37, this._RequestOptions_38));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocationStrategy_41", {
        get: function () {
            if ((this.__LocationStrategy_41 == null)) {
                (this.__LocationStrategy_41 = import8.provideLocationStrategy(this.parent.get(import38.PlatformLocation), this.parent.get(import39.APP_BASE_HREF, null), this._ROUTER_CONFIGURATION_40));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Router_47", {
        get: function () {
            if ((this.__Router_47 == null)) {
                (this.__Router_47 = import8.setupRouter(this._ApplicationRef_15, this._UrlSerializer_43, this._RouterOutletMap_44, this._Location_42, this, this._NgModuleFactoryLoader_45, this._Compiler_16, this._ROUTES_46, this._ROUTER_CONFIGURATION_40));
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ROUTER_FORROOT_GUARD_6 = import8.provideForRootGuard(this.parent.get(import41.Router, null));
        ...
        this._ApplicationRef__14 = new import12.ApplicationRef_(this.parent.get(import36.NgZone), this.parent.get(import42.Console), this, this._ErrorHandler_11, this, this._ApplicationInitStatus_12, this.parent.get(import11.TestabilityRegistry, null), this._Testability_13);
